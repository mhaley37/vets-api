...
module AppsApi
  class NotificationService < Common::Client::Base
    ...
    def event_already_handled?(parsed_hash)
      ...
      members = RedisCache.redis.smembers('apps_notification_events')
      ...
      members.each do |member|
        member_hash = RedisCache.redis.hgetall(member)
