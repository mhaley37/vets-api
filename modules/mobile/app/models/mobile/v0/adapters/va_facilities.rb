      ...
      class VAFacilities
        def map_appointments_to_facilities(appointments, facilities)
          if Flipper.enabled?(:mobile_appointment_use_VAOS_MFS)
            new_map_appointments_to_facilities(appointments, facilities)
          else
            legacy_map_appointments_to_facilities(appointments, facilities)
          end
        end

        def new_map_appointments_to_facilities(appointments, facilities)
        ...
        def legacy_map_appointments_to_facilities(appointments, facilities)
          facilities_by_id = facilities&.index_by(&:id)
