...
RSpec.describe FastTrack::HypertensionMedicationRequestData, :vcr do
  ...
  describe '#transform' do
    ...
    it 'returns the expected hash from a single-entry list' do
      transformed_response = described_class.new(response).transform
      expect(transformed_response).to match(
        [{"status"=>"active",
         ...
         {"status"=>"active",
          ...
          "notes"=>["Hydrochlorothiazide 25 MG"],
          "dosageInstructions"=>["Once per day.", "As directed by physician."]},
         {"status"=>"active", "authoredOn"=>"2013-04-14T06:00:00Z", "description"=>"Hydrochlorothiazide 25 MG", "notes"=>[], "dosageInstructions"=>[]},
         {"status"=>"active",
          "authoredOn"=>"2012-08-18T06:15:52Z",
          "description"=>"predniSONE 5 MG Oral Tablet",
          "notes"=>["predniSONE 5 MG Oral Tablet"],
          "dosageInstructions"=>["1 dose(s) 1 time(s) per 1 days", "As directed by physician."]},
         {"status"=>"active",
          "authoredOn"=>"2012-08-18T06:15:52Z",
          "description"=>"predniSONE 5 MG Oral Tablet",
          "notes"=>["predniSONE 5 MG Oral Tablet"],
         ...
         {"status"=>"active",
          ...
          "notes"=>["Loratadine 5 MG Chewable Tablet"],
          "dosageInstructions"=>["Once per day.", "As directed by physician."]},
         {"status"=>"active", "authoredOn"=>"1995-04-29T06:00:00Z", "description"=>"Loratadine 5 MG Chewable Tablet", "notes"=>[], "dosageInstructions"=>[]},
         {"status"=>"active", "authoredOn"=>"1995-04-29T06:00:00Z", "description"=>"0.3 ML EPINEPHrine 0.5 MG/ML Auto-Injector", "notes"=>[], "dosageInstructions"=>[]},
         {"status"=>"active",
