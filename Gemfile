...
gem 'pundit'
gem 'rack'
gem 'rack-attack', github: 'rack/rack-attack', branch: 'main' # FIXME: Pointing to GH just for testing
gem 'rack-cors', require: 'rack/cors'
gem 'rails_semantic_logger'
gem 'rails-session_cookie'
gem 'redis'
gem 'redis-namespace', github: 'resque/redis-namespace' # FIXME: Pointing to GH just for testing
gem 'request_store'
gem 'restforce'
gem 'rgeo-geojson'
gem 'rswag-ui'
