...
class SignInController < ApplicationController
  ...
  def token
    ...
    sign_in_logger.info_log('Sign in Service Token Response', { code: code }, session_container.refresh_token)
  ...
  def refresh
    ...
    sign_in_logger.info_log('Sign in Service Tokens Refresh', {}, session_container.refresh_token)
    render json: session_token_response(session_container), status: :ok
  rescue => e
    render json: { errors: e }, status: :unauthorized
  end
  ...
  def introspect
    sign_in_logger.info_log('Sign in Service Introspect', {}, bearer_token)
  ...
  def revoke_session(refresh_token, anti_csrf_token, enable_anti_csrf)
    ...
    sign_in_logger.info_log('Sign in Service Session Revoke', {}, refresh_token)
